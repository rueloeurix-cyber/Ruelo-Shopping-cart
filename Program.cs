            ...
            while (running)
            {
                ...
                switch (choice)
                {
                    ...
                    case "4":
                        ...
                        {
                            double sub = cart[i].GetSubtotal();
                            Console.WriteLine($"{cart[i].Product.Id}. {cart[i].Product.Name} x{cart[i].Quantity} = ₱{sub}");
                        }
                        ...
                        for (int i = 0; i < cartCount; i++)
                        {
                            removeIds += cart[i].Product.Id;
                            if (i < cartCount - 1) removeIds += ", ";
                        }

                        Console.Write($"Enter product ID to remove ({removeIds}): ");
                    ...
                    case "5":
                        ...
                        for (int i = 0; i < cartCount; i++)
                        {
                            updateIds += cart[i].Product.Id;
                            if (i < cartCount - 1) updateIds += ", ";
                        }

                        Console.Write($"Enter product ID to update the quantity ({updateIds}): ");
